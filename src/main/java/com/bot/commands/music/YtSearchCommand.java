...
public class YtSearchCommand implements Command {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        String link = "ytsearch: " + event.getOption("title").getAsString();
        PlayerManager.getInstance().search(event, link);
        event.getHook().sendMessage("Search results: (type /ytsearch <number> to play)\n").queue();
    }
